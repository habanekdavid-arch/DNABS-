...
export const onasChapters: OnasChapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      {
        sk: "Sako, ktoré stojí samo, bez tela, ktoré by ho nosilo, je dobrou metaforou pre to, ako pristupujeme k práci — chceme, aby hovoril výsledok, nie my. Návrh webu na mieru do 24 hodín zadarmo nie je marketingový trik, je to spôsob, ako ti ukázať, čo vieme spraviť, skôr než sa rozhodneš investovať čas alebo peniaze.",
        en: "A blazer standing on its own, with no body wearing it, is a fitting metaphor for how we approach work — we want the result to speak, not us. A custom website design within 24 hours, free, isn't a marketing gimmick — it's a way to show you what we can do before you decide to invest time or money.",
      },
      {
